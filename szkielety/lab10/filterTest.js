...
describe("Funkcja filtrująca", () => {
    test("filtrowanie na podstawie wyszukanego terminu (link)", () => {
        const input = [
    ...
    test("filtrowanie na podstawie wyszukanego terminu (planeta)", () => {
        const input = [
            { id: 1, planeta: "Merkury", url: "https://pl.wikipedia.org/wiki/Merkury" },
            { id: 2, planeta: "Wenus", url: "https://pl.wikipedia.org/wiki/Wenus" },
            { id: 3, planeta: "Ziemia", url: "https://pl1.wikipedia.org/wiki/Ziemia" }
        ...
        const output = [{ id: 2, planeta: "Wenus", url: "https://pl.wikipedia.org/wiki/Wenus" }]

        expect(filterByTerm2(input, "Wenus")).toEqual(output)
    })
})